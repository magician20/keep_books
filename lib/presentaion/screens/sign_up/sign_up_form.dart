...
import 'package:keep_books/presentaion/screens/sign_up/widgets/entery_field_email_widget.dart';
import 'package:keep_books/presentaion/screens/sign_up/widgets/entery_field_first_name_widget.dart';
import 'package:keep_books/presentaion/screens/sign_up/widgets/entery_field_password_widget.dart';
...
class _SignUpFormPageState extends State<SignUpFormPage> {
  ...
  static final _formKey = GlobalKey<FormState>(debugLabel: "signUpForm");
          ...
          (either) {
            either.fold(
              ...
              (_) {
                ...
                //3- emit event for login page
                //4-lisent to login state & if it true then
                //5-unloading screen & push to home page
                //6-else stop loading screen & show error message
              },
            );
          },
        );
